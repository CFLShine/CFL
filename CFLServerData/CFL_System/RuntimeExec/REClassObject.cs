...
namespace RuntimeExec
{
    ...
    public class REClassObject : REExpression
    {
        ...
        /// l'expose par la propriété <see cref="ReValue"/>.
        /// </summary>
        ...
        public REClassObject(string _typeName)
        {
            TypeName = _typeName;
        }
        ...
        {
            return new REClassObject(TypeName);
        }

        /// <summary>
        /// Ajoute la propriété à cet objet, lui donne cet objet comme <see cref="REBase.Parent"/>.
        ...
        /// <summary>
        /// Ajoute le champs à cet objet, lui donne cet objet comme <see cref="REBase.Parent"/>.
        ...
        {
            if(_object != null && _object.GetType().Name == TypeName)
                CValue = _object;
            return this;
        }
